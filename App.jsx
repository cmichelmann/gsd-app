...
.month-day { background: var(--s0); min-height: 60px; padding: 3px 2px; position: relative; cursor: pointer; transition: background 0.12s; }
...
.day-num { font-size: 9px; color: var(--muted); margin-bottom: 2px; font-family: 'JetBrains Mono'; }
.day-task-bar { color: #000; font-size: 7px; padding: 1px 2px; border-radius: 2px; font-weight: 600; margin-bottom: 1px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; line-height: 1.2; cursor: pointer; }
